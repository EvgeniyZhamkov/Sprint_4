...
public class FaqQuestionsTest {
    ...
    public FaqQuestionsTest (int idQuestionText, String questionText) {
    ...
    public void testDropDownListText() {
        ...
        actualText.checkAccordionItemOpensAndShowsExpectedText(idQuestionText, questionText);
        //assertEquals(driver, questionText);
    }
